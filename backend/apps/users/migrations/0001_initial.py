    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='Profile Photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_county', models.CharField(blank=True, max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['is_verified'], name='users_landl_is_veri_be9d8c_idx'),
        ),
    ]
